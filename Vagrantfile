...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    sudo cpanm --notest --force HTML::FormFu::Model::DBIC CatalystX::SimpleLogin DBIx::Class::TimeStamp Catalyst::Plugin::StatusMessage DBIx::Class::PassphraseColumn Catalyst::Model::DBIC::Schema CatalystX::Component::Traits HTML::FormFu::MultiForm MooseX::Traits::Pluggable
